 ...
 echo "<h2>Orderlist</h2>"; 
   ...
   for($j=0;$j<count($_POST["menu"]);$j++){
		...
		if(trim($_POST["menu"][$j]) != " "){
			...
			echo $subData[1]." Price : ". $subData[2]." x".$_POST["num"][$subData[0]]." ".$subData[2]*$_POST["num"][$subData[0]]." BATH"."<br>";
...
echo "<a href='Orderguest.php'>Cancel Order</a><br>";
}
...
<form action='Orderguest.php' method='post'>
